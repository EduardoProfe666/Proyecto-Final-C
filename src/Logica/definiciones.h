...
//Constantes Estructura Piscina de Datos |NO MODIFICAR PARA EL CORRECTO FUNCIONAMIENTO DEL PROGRAMA|
#define CANT_DATOS_PERSONALES_PD 50
...
#define MAX_NOMBRE_APELLIDO_DEPORTE_PD 20
...
#define NOMBRE_USUARIO "eduardoProfe666"
#define CONTRASENYA "********"
