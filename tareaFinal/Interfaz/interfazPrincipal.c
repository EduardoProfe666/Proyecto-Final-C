...
void interfazPrincipal(DatosAnyo datosAnyo[], BD baseDatos, COORD posicionMarco){
    ...
    do{
        ...
        if(comandoOrqui)
            ...
            case 1:
                ...
                if(respuestaTemp){
                    inicializarDatos(datosAnyo, baseDatos, &cantidadAnyos);
            ...
            case 2:
                ...
                if(respuestaTemp){
                    introducirDatosUsuario(datosAnyo,&baseDatos,&cantidadAnyos,&datosExistentes,posicionMarco);
                }
                break;
            case 3:
                if(datosExistentes)
            ...
            case 7:
                if(datosExistentes)
                    mostrarReporteParticipantesDadoAnyoDeporte(datosAnyo,baseDatos,cantidadAnyos,posicionMarco);
                else
                    comunicarDatosNoInicializadosErr(posicionMarco);
                break;
            default:
